...
require([
    ...
    if (null != localStorage.getItem("globalUserServiceTypeList") && "" !== localStorage.getItem("globalUserServiceTypeList")) {
        ...
        function reloadAll() {
    var mnpData = getOnlySearchResultsConstructor(getQuery("operationsMnpQuery", "ops_post_mnp_daily_chart", country, "", "", serviceType), "mnpchartPreloader", "24h");
    ...
    var mnpDataMonthly = getOnlySearchResultsConstructor(getQuery("operationsMnpQuery", "ops_post_mnp_monthy_chart", country, "", "", serviceType), "mnpchartPreloader", "24h");
    ...
    var mnpDataWeekly = getOnlySearchResultsConstructor(getQuery("operationsMnpQuery", "ops_post_mnp_weekly_chart", country, "", "", serviceType), "mnpchartPreloader", "24h");
    ...
    function getOnlySearchResultsConstructor(query, id, interval) {
        ...
        function downloadChartData() {
            ...
            var queryMapKey = "operationsMnpQuery";
            getResultsAndExport(queryMapKey, "postpaidMNPData", country, fromDate, toDate);
            return false;
        }
