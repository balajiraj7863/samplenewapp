...
function loadOrderStatusChart(chartType, rows) {
    ...
    if ("tillDate" === chartType || "today" === chartType) {
        ...
        processStackBarData(rows, opsIncOrderDrilldown[chartType].statuswise, "orderStatusChart", fixedOrderStatus, "txndate", "orderstatus", "totalorders");
    } 
}
...
function loadOrderPlanChart(chartType, rows) {
    ...
    if ("tillDate" === chartType || "today" === chartType) {
        ...
        processStackBarData(rows,opsIncOrderDrilldown[chartType].planwise, 'planwiseChart', "", 'txndate', 'tariff_dec', 'totalorders');
    } 
}
