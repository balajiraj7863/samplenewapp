require([
    ...
    function reloadAll() {
        ...
        orderByCountryData.on('search:done', function () {
            ...
            refreshDateTime();
            Highcharts.chart('orderCountrywiseChart', bizOpsPostEmpty.emptyChartConfig.emptyChart);
        });
        ...
        incidentAgeingData.on('search:done', function () {
            ...
            refreshDateTime();
            Highcharts.chart('incidentsAgeschart', bizOpsPostEmpty.emptyChartConfig.emptyChart);
        });
        ...
        incidentCountryData.on('search:done', function () {
            ...
            refreshDateTime();
            Highcharts.chart('countryChart', bizOpsPostEmpty.emptyChartConfig.emptyChart);
        });
        ...
        orderAgeingData.on('search:done', function () {
            ...
            refreshDateTime();
            Highcharts.chart('orderAgingChart', bizOpsPostEmpty.emptyChartConfig.emptyChart);
        });
        ...
        mnpData.on('search:done', function () {
            ...
            refreshDateTime();
            Highcharts.chart('mnpChart', bizOpsPostEmpty.emptyChartConfig.emptyChart);
        });
        ...
        billiingMediationData.on('search:done', function () {
            ...
            refreshDateTime();
            Highcharts.chart('serviceChart', bizOpsPostEmpty.emptyChartConfig.emptyChart);
        });
            ...
            openIncidentHomeBannerSearchResults.on("data", function (queryResults) {
                if (undefined !== queryResults.data()) {
                    if (null !== queryResults.data().rows) {
                        ...
                        getBannerHelpText("opsPostDashboardHelp", "incidentBannerHelp");
                        ...
                        $('#ops_post_incidentp1banner').text( priorityData.p1);
                        $('#ops_post_incidentp2banner').text( priorityData.p2);
                    }
                }
            });
            ...
            orderBannerSearchResults.on("data", function (queryResults) {
                if (undefined !== queryResults.data()) {
                    if (null !== queryResults.data().rows) {
                        ...
                        getBannerHelpText("opsPostDashboardHelp", "orderBannerHelp");
                        ...
                        $('#ops_post_orderCurrentBanner').text(orderData.Current);
                        $('#ops_post_orderCompletedBanner').text(orderData.Completed);
                    }
                }
            });
            ...
            mnpBannerSearchResults.on("data", function (queryResults) {
                if (undefined !== queryResults.data()) {
                    if (null !== queryResults.data().rows) {
                        ...
                        getBannerHelpText("opsPostDashboardHelp", "mnpBannerHelp");
        ...
        var trafficBannerSearchData = getOnlySearchResultsConstructor(getQuery("operationsPostQuery", "ops_postpaid_traffic_banner", country, "", "", serviceType), "biz_traffic_banner");
        trafficBannerSearchData.on('search:done', function () {
            ...
            trafficBannerSearchResults.on("data", function (trafficBanner) {
                if (undefined !== trafficBanner.data()) {
                    ...
                    $('#trafficBannerTooltip').attr("data-original-title", getBannerHelpText("bizPostpaidHelp", "trafficBannerHelp"));
                }
            });
