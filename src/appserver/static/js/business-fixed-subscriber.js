...
require(
    ...
    function (mvc, utils, TokenUtils, _, $, DashboardController,
        ...
        function loadChart(chartType) {
            ...
            if ("" !== fromDate && "" !== toDate) {
                ...
                countryWiseSearchData.settings.set("search", getQuery(
                    "bizPostDrillSubQuery", cntryQuery, country,
            ...
            if ("tillDate" === chartType) {
                ...
                subExitSearchData.on('search:done', function (properties) {
            ...
            if ("tillDate" === chartType) {
                $("#subLabel").text("Subscriber - Loyalty");
                ...
                subLoyaltySearchData.on('search:done',
                    function (properties) {
        ...
        function loadExitChart(chartType, rows) {
            Highcharts.chart('exitReasonChart',
