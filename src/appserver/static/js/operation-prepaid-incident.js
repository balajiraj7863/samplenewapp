...
function highchartsInitialize() {
    orderStatusChartInit = Highcharts.chart('statuswiseChart', opsIncPostDrilldown.tillDate.statuswise);
    priorityChartInit = Highcharts.chart('prioritywiseChart', opsIncPostDrilldown.tillDate.prioritywise);
    systemChartInit = Highcharts.chart('systemwiseChart', opsIncPostDrilldown.tillDate.systemwise);
    queueChartInit = Highcharts.chart('queuewiseChart', opsIncPostDrilldown.tillDate.queuewise);
