require([
    ...
    function (
        ...
        updateHelpText('monitorPostDashboardHelp');
        ...
        if (null != localStorage.getItem("globalUserServiceTypeList") && "" !== localStorage.getItem("globalUserServiceTypeList")) {
            if (localStorage.getItem("globalUserServiceTypeList").indexOf("monitoring-postpaid") > -1) {
        ...
        var interfaceList = d3.map()
            ...
            .set("", "");
        // click for IM flow
        $("#interfacePostMonitorId").click(function () {
            $("#preloader").show();
            $('#status').show();
        ...
        $("#sitePostMonitorId").click(function () {
            $("#preloader").show();
            $('#status').show();
            $('#preloader').delay(2000).fadeOut('slow');
            $('#status').delay(2000).fadeOut('slow');
